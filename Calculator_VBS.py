...
label = Label(window, textvariable=equation_label, font=('consolas', 20), anchor="e", bg="white", width=24, height=2, relief="groove",bd=4)
label.pack(pady=10)
frame = Frame(window)
frame.pack()
...
plus = Button(frame, text='+', height=4, width=9, font=35, bg='orange', fg='white', command=lambda:button_press('+'))
plus.grid(row=0,column=3)

minus = Button(frame, text='-', height=4, width=9, font=35, bg='orange', fg='white', command=lambda:button_press('-'))
minus.grid(row=1,column=3)

multiply = Button(frame, text='*', height=4, width=9, font=35, bg='orange', fg='white', command=lambda:button_press('*'))
multiply.grid(row=2,column=3)

divide = Button(frame, text='/', height=4, width=9, font=35,bg='orange', fg='white', command=lambda:button_press('/'))
...
clear = Button(window, text='C', height=4, width=20, font=35,bg='black', fg='white', command=clear)
clear.pack()
window.mainloop()